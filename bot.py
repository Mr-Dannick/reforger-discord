...
class TMuxMonitorBot(commands.Bot):
    ...
    def load_config(self):
        default_config = {
            ...
            # battlemetrics token you can generate at: https://www.battlemetrics.com/developers
            'battlemetrics_server_id': None
            # server id you can find by going to your server page at battle metrics exapmle: https://www.battlemetrics.com/servers/reforger/31762279 31762279 is the server id
        }
...
async def restart_service(interaction: discord.Interaction):
    ...
    try:
        ...
        await interaction.response.send_message(f"Service {service_name} has been restarted successfully!",
                                                ephemeral=False)
    except subprocess.CalledProcessError as e:
